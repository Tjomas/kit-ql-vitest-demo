...
declare module '$env/static/private' {
	...
	export const K9S_CONFIG_DIR: string;
	export const K9S_LOGS_DIR: string;
	...
	export const RED_NPM_TOKEN: string;
